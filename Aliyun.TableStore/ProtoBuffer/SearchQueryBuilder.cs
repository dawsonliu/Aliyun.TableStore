...
using Aliyun.TableStore.ProtoBuffer;
...
namespace com.alicloud.openservices.tablestore.core.protocol
{
    ...
    {
        public static QueryType BuildQueryType(Aliyun.TableStore.DataModel.Search.Query.QueryType type)
        {
            switch (type)
            {
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_MatchQuery:
                    return QueryType.MATCH_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_MatchPhraseQuery:
                    return QueryType.MATCH_PHRASE_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_TermQuery:
                    return QueryType.TERM_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_TermsQuery:
                    return QueryType.TERMS_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_RangeQuery:
                    return QueryType.RANGE_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_PrefixQuery:
                    return QueryType.PREFIX_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_BoolQuery:
                    return QueryType.BOOL_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_ConstScoreQuery:
                    return QueryType.CONST_SCORE_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_FunctionScoreQuery:
                    return QueryType.FUNCTION_SCORE_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_NestedQuery:
                    return QueryType.NESTED_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_WildcardQuery:
                    return QueryType.WILDCARD_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_MatchAllQuery:
                    return QueryType.MATCH_ALL_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_GeoBoundingBoxQuery:
                    return QueryType.GEO_BOUNDING_BOX_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_GeoDistanceQuery:
                    return QueryType.GEO_DISTANCE_QUERY;
                case Aliyun.TableStore.DataModel.Search.Query.QueryType.QueryType_GeoPolygonQuery:
        ...
        public static PrefixQuery BuildPrefixQuery(Aliyun.TableStore.DataModel.Search.Query.PrefixQuery query)
        {
        ...
        public static WildcardQuery BuildWildcardQuery(Aliyun.TableStore.DataModel.Search.Query.WildcardQuery query)
        {
        ...
        public static BoolQuery BuildBoolQuery(Aliyun.TableStore.DataModel.Search.Query.BoolQuery query)
        {
        ...
        public static ConstScoreQuery BuildConstScoreQuery(Aliyun.TableStore.DataModel.Search.Query.ConstScoreQuery query)
        {
        ...
        public static FieldValueFactor BuildFieldValueFactor(Aliyun.TableStore.DataModel.Search.Query.FieldValueFactor fieldValueFactor)
        {
        ...
        public static ScoreMode BuildScoreMode(Aliyun.TableStore.DataModel.Search.Query.ScoreMode scoreMode)
        {
            switch (scoreMode)
            {
                case Aliyun.TableStore.DataModel.Search.Query.ScoreMode.Max:
                    return ScoreMode.SCORE_MODE_MAX;
                case Aliyun.TableStore.DataModel.Search.Query.ScoreMode.Min:
                    return ScoreMode.SCORE_MODE_MIN;
                case Aliyun.TableStore.DataModel.Search.Query.ScoreMode.Avg:
                    return ScoreMode.SCORE_MODE_AVG;
                case Aliyun.TableStore.DataModel.Search.Query.ScoreMode.Total:
                    return ScoreMode.SCORE_MODE_TOTAL;
                case Aliyun.TableStore.DataModel.Search.Query.ScoreMode.None:
        ...
        public static NestedQuery BuildNestedQuery(Aliyun.TableStore.DataModel.Search.Query.NestedQuery query)
        {
        ...
        public static GeoDistanceQuery BuildGeoDistanceQuery(Aliyun.TableStore.DataModel.Search.Query.GeoDistanceQuery query)
        {
